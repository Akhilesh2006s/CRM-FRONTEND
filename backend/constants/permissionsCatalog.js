...
const PAGE_ENTRIES = [
  ...
  { href: '/dashboard/leads/cross-sale', module: 'leads', resource: 'cross_sale', label: 'Cross-Sale Leads' },
  { href: '/dashboard/visits', module: 'leads', resource: 'visits', label: 'School Visits' },
  { href: '/dashboard/collateral', module: 'leads', resource: 'collateral', label: 'Sales Collateral' },
  // Employees
  ...
  { href: '/dashboard/employees/verification', module: 'employees', resource: 'verification', label: 'Employee Verification' },
  { href: '/dashboard/executives/assign-areas', module: 'employees', resource: 'assign_areas', label: 'Assign Areas' },
  { href: '/dashboard/employees/zones', module: 'employees', resource: 'zones', label: 'Zones & Clusters' },
  { href: '/dashboard/employees/clusters', module: 'employees', resource: 'clusters', label: 'Clusters' },
  { href: '/dashboard/employees/move-schools', module: 'employees', resource: 'move_schools', label: 'Move Schools' },
  { href: '/dashboard/employees/cluster-schools', module: 'employees', resource: 'cluster_schools', label: 'Cluster Schools' },
  { href: '/dashboard/employees/chain', module: 'employees', resource: 'chain', label: 'Chain' },
  { href: '/dashboard/employees/requests', module: 'employees', resource: 'requests', label: 'Employee Requests' },
  { href: '/dashboard/employees/salary', module: 'employees', resource: 'salary', label: 'Salary' },
  { href: '/dashboard/employees/payslips', module: 'employees', resource: 'payslips', label: 'Pay Slips' },
  { href: '/dashboard/employees/history', module: 'employees', resource: 'history', label: 'Employee History' },
  { href: '/dashboard/executive-managers', module: 'employees', resource: 'assign_managers', label: 'Assign Managers' },
  // Leaves
  ...
  { href: '/dashboard/training/request', module: 'training', resource: 'request', label: 'Training Request' },
  { href: '/dashboard/training/requests', module: 'training', resource: 'requests', label: 'Training Requests' },
  // Warehouse
  ...
  { href: '/dashboard/returns/executive', module: 'returns', resource: 'executive', label: 'BDE Stock Returns' },
...
const ROLE_TEMPLATE_KEYS = {
  ...
  'hr-manager': [
    ...
    pageKey('employees', 'inactive'),
    pageKey('employees', 'verification'),
    pageKey('employees', 'new'),
    pageKey('employees', 'requests'),
    pageKey('employees', 'salary'),
    pageKey('employees', 'payslips'),
    pageKey('employees', 'history'),
    buttonKey('employees', 'active', 'add'),
    buttonKey('employees', 'active', 'edit'),
    moduleKey('leaves'),
    pageKey('leaves', 'pending'),
    pageKey('leaves', 'report'),
    pageKey('leaves', 'request'),
    pageKey('leaves', 'approved'),
    moduleKey('settings'),
    pageKey('settings', 'password'),
  ],
  /** HR Executive — same HR tools as Super Admin; new employees wait for HR Manager approval */
  'hr-executive': [
    moduleKey('dashboard'),
    pageKey('dashboard', 'home'),
    moduleKey('employees'),
  ...
  executive: [
    ...
    pageKey('leads', 'cross_sale'),
    pageKey('leads', 'visits'),
    pageKey('leads', 'collateral'),
    moduleKey('clients'),
    ...
    pageKey('leaves', 'approved'),
    moduleKey('training'),
    pageKey('training', 'request'),
    moduleKey('complaints'),
    pageKey('complaints', 'raise'),
    moduleKey('settings'),
    pageKey('settings', 'password'),
  ],
  manager: [
  ...
  coordinator: [
    ...
    pageKey('training', 'requests'),
    moduleKey('complaints'),
    pageKey('complaints', 'inbox'),
    moduleKey('warehouse'),
    pageKey('warehouse', 'dc_at_warehouse'),
    pageKey('warehouse', 'completed_dc'),
    buttonKey('warehouse', 'completed_dc', 'view_pdf'),
