...
export const HREF_PERMISSION_MAP: Record<string, string> = {
  ...
  '/dashboard/leads/cross-sale': 'leads.cross_sale.page.view',
  '/dashboard/visits': 'leads.visits.page.view',
  '/dashboard/collateral': 'leads.collateral.page.view',
  ...
  '/dashboard/employees/verification': 'employees.verification.page.view',
  '/dashboard/executives/assign-areas': 'employees.assign_areas.page.view',
  '/dashboard/employees/zones': 'employees.zones.page.view',
  '/dashboard/employees/clusters': 'employees.clusters.page.view',
  '/dashboard/employees/move-schools': 'employees.move_schools.page.view',
  '/dashboard/employees/cluster-schools': 'employees.cluster_schools.page.view',
  '/dashboard/employees/chain': 'employees.chain.page.view',
  '/dashboard/employees/requests': 'employees.requests.page.view',
  '/dashboard/employees/salary': 'employees.salary.page.view',
  '/dashboard/employees/payslips': 'employees.payslips.page.view',
  '/dashboard/employees/history': 'employees.history.page.view',
  '/dashboard/executive-managers': 'employees.assign_managers.page.view',
  ...
  '/dashboard/training/request': 'training.request.page.view',
  '/dashboard/training/requests': 'training.requests.page.view',
  '/dashboard/complaints/raise': 'complaints.raise.page.view',
  '/dashboard/complaints': 'complaints.inbox.page.view',
